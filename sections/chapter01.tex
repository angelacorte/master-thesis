...
Computing devices are becoming cheaper and \emph{ubiquitous}, increasing the complexity of distributed systems.
...
\begin{figure}
    ...
    \caption{The system model of \xc{}.}
    \label{fig:xc-system-model}
\end{figure}

For example, in the \Cref{fig:xc-system-model}, the device $\delta_2$ executes two computation rounds $\epsilon_1$ and
$\epsilon_2$.
