...
It allows running aggregate programs on low computational capacity devices, although it has a less ergonomic syntax
compared to other languages, which means that is unlikely that it can reach a mainstream developer audience.
