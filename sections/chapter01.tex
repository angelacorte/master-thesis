...
In this context, the tuple-based middleware TOTA (Tuples On The Air) ~\cite{10.1145/1538942.1538945} has been suggested to support field-based
...
As seen in the \emph{Protelis} architecture (Figure ~\ref{fig:protelis-structure}), an interpreter executes a pre-parsed program at regular intervals,
