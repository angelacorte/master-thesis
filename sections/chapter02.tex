...
\paragraph{Repeat}
%todo why is not implemented in terms of exchange
The \texttt{repeat} function is the equivalent of the \texttt{rep} construct in \emph{field calculus}.
It models the state evolution over time, the value of \emph{initial} evolves at each execution depening on the \emph{transform} function,
