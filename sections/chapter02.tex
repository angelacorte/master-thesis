...
It takes as parameter \emph{local} (\Cref{lst:neighboring}), which can be an expression or a value, and returns a \emph{field} of the same input type.
...
Those constructs will be explained in detail in the sections \Cref{subsec:aggregate-context} and \Cref{subsec:aggregate-operators}.
