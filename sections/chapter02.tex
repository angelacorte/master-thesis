...
Since during the execution the control on the effective alignment of two functions is made simply by comparing the two resulting strings,
the control of the entire \emph{Path} turns out to be less efficient than the initial one on the aggregate functions only.
